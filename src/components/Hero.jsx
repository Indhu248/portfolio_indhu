   ...
   <section className="relative w-full h-[32rem] lg:h-screen mx-auto flex flex-col justify-between">
    ...
    max-w-7xl mx-auto flex flex-row items-start gap-5 py-10 justify-between`}>
      ...
      <div>
        ...
        <p className={`${styles.heroSubText} mb-8 text-white-100`}>I'm a front-end <span className='text-[#915eff]'>developer</span> and<br className="sm:block hidden"/>
         UI <span className='text-[#915eff]'>designer.</span></p>
         <a className="bg-[#6d28d9] rounded-md text-center px-6 py-3 w-40 mt-10" href="https://drive.google.com/file/d/1tkQQrP1ppL6_3aM04Nufn-gFczYQgRaL/view?usp=sharing">Resume</a>
      </div>
